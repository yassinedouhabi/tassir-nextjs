...
export function LoginForm({ className, ...props }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const RegisterLink = (
      <div>
        {res.error}. Register your account:{' '}
      ...
      <Card className='overflow-hidden p-0'>
        <CardContent className='grid p-0 md:grid-cols-2'>
          <form onSubmit={handleSubmit} className='p-6 md:p-8'>
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col items-center text-center'>
                ...
                <p className='text-muted-foreground text-balance'>Login to your Tassir account</p>
              </div>
          ...
          <div className='bg-muted relative hidden md:block'>
            <Image src={LoginImage} alt='Login' className='absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale' />
          </div>
        </CardContent>
      </Card>
